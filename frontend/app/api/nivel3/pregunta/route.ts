...
const FALLBACK_QUESTIONS: Record<string, object> = {
  ...
  react: {
    ...
    opciones: {
      ...
      B: 'Los modelos no podían generar código ejecutable',
      C: 'Los modelos consumían demasiada memoria GPU',
      D: 'Los modelos solo razonaban O solo actuaban, no ambas cosas a la vez',
    },
  ...
  tool_calling: {
    ...
    opciones: {
      A: 'Tool Calling genera JSON estructurado de forma nativa sin prompt engineering adicional',
      B: 'Tool Calling es más barato en tokens de entrada',
