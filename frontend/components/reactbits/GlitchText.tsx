// SOURCE: https://www.reactbits.dev/text-animations/glitch-text
// GitHub: https://github.com/DavidHDev/react-bits
//
// DEPENDENCIES: none (pure Tailwind CSS, no npm packages)
//
// TAILWIND CONFIG REQUIRED — add to tailwind.config.ts:
//
// keyframes: {
//   glitch: {
...
//   enableShadows   boolean  — show red/cyan color shadows (default: true)
//   enableOnHover   boolean  — only glitch on hover (default: false)
